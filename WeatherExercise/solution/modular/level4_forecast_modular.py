"""
Level 4 MODULAR: Complete Weather Station (Observer Pattern)
=============================================================

Complete Observer pattern with all features.
- CurrentConditionsDisplay shows current weather
- AlertSystem monitors for warnings
- StatisticsDisplay tracks trends
- ForecastDisplay predicts weather based on pressure
- All observers work independently
"""
...
class ForecastDisplay:
    ...
    def update(self, temperature, humidity, pressure):
        """Receive weather update and analyze forecast."""
    ...
    def display(self):
        ...
        if len(self._pressure_readings) < 3:
            ...
            recent = self._pressure_readings
